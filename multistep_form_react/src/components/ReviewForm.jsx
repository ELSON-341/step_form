  ...
  return (
    <div className="review-form">
      ...
      <div className="form-control">
        ...
        <textarea name="comment" id="comment" placeholder="Conte como foi a sua experiêcia com o produto..." required value={data.comment || ""} onChange={(e) => updateFieldHandler("comment", e.target.value)}></textarea>
      </div>
    </div>
  )
}
